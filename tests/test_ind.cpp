...
void CheckINDsListsEquality(algos::INDAlgorithm::INDList const& actual, IndsTest const& expected) {
...
void CheckTablesInfoEquality(algos::INDAlgorithm::DatasetsOrder const& actual,
...
TEST_F(INDAlgorithmTest, CIPublic700) {
    IndsTest expected_inds{{{{0, {17}}, {0, {0}}},
                {{0, {17}}, {0, {1}}},
                {{0, {17}}, {0, {2}}},
                {{0, {17}}, {0, {3}}},
                {{0, {17}}, {0, {4}}},
...
TEST_F(INDAlgorithmTest, EpicMeds) {
    IndsTest expected_inds{{{{0, {9}}, {0, {0}}},
                            {{0, {9}}, {0, {1}}},
                            {{0, {9}}, {0, {2}}},
                            {{0, {9}}, {0, {7}}},
                            {{0, {9}}, {0, {8}}},
