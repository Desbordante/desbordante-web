...
const NumberSlider: ForwardRefRenderFunction<HTMLInputElement, Props> = (
  ...
  const marks = (sliderProps?.step || 1) % 1 === 0 ? {[min]: {style: {top: -40}, label: min}, [dot1]: " ", [dot2]:{style: {top: -40}, label: [dot2]}, [dot3]: " ", [max]: {style: {top: -40}, label: max}} : {[min]: {style: {top: -40}, label: min}, [dot1]: " ", [dot2]:{style: {top: -40}, label: [dot2]}, [dot3]: " ", [max]: {style: {top: -40}, label: max}}
